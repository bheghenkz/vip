...
Exp1=$(curl -sS https://raw.githubusercontent.com/bheghenkz/vip/main/ip | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
...
wget -q -O https://raw.githubusercontent.com/bheghenkz/vip/main/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
clear
clear
...
sleep 2
clear
curl "https://raw.githubusercontent.com/bheghenkz/vip/main/menu/ssh-vpn.sh" | bash
sleep 2
wget https://raw.githubusercontent.com/bheghenkz/vip/main/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
wget -q -O demeling.sh https://raw.githubusercontent.com/bheghenkz/vip/main/demeling.sh && chmod +x demeling.sh && ./demeling.sh
cd
mkdir -p /root/udp
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
...
sleep 2
clear
curl "https://raw.githubusercontent.com/bheghenkz/vip/main/Insshws/insshws.sh" | bash
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/bheghenkz/vip/main/menu/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/bheghenkz/vip/main/Finaleuy/notramcpu" && chmod +x /usr/bin/notramcpu
cd
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
curl "https://raw.githubusercontent.com/bheghenkz/vip/main/menu/insray.sh" | bash
sleep 1
curl "https://raw.githubusercontent.com/bheghenkz/vip/main/arca.sh" | bash
sleep 1
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install slowdns               $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -q -O slowdns.sh https://raw.githubusercontent.com/bheghenkz/vip/main/SLDNS/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
mkdir /root/akun
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 1
curl "https://raw.githubusercontent.com/bheghenkz/vip/main/ipsec/ipsec.sh" | bash
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install OPENVPN             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
wget "https://raw.githubusercontent.com/bheghenkz/vip/main/Insshws/vpn.sh" && bash vpn.sh && rm vpn.sh
clear
echo "Installing Bot Panel" | lolcat
echo "Siapkan Token bot dan ID telegram mu"
rm -rf bot.sh && wget https://raw.githubusercontent.com/bheghenkz/vip/main/botssh/bot.sh && chmod 777 bot.sh && ./bot.sh && systemctl restart cybervpn
USERID="7119809739"
KEY="7219320936:AAGQl5rVRkSjQ1hB0uNqvyfwoj8rX7BiYKw"
TIMEOUT="10"
